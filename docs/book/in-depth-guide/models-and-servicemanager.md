...
and with this, introduce laminas-servicemanager.
...
Factory classes for laminas-servicemanager may implement either
`Laminas\ServiceManager\Factory\FactoryInterface`, or be callable classes (classes
...
case, is a `Laminas\ServiceManager\ServiceManager` instance. The container also
...
> #### Aliasing services
>
> In laminas-servicemanager, when you request a service by an alias you get the service
...
`Laminas\View\Model\ViewModel`; this is what controllers will usually return within
laminas-mvc applications. `ViewModel` instances allow you to provide variables to
...
> a normal PHP array, laminas-mvc internally converts it into a `ViewModel`. The
...
- How to use laminas-servicemanager to implement dependency injection in laminas-mvc
  applications.
