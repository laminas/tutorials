<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <p>
            ...
            zend-mvc application, testing it, and adding features to it. The
        ...
        <ul class="list-group">
            <li class="list-group-item"><a href="getting-started/overview/">Getting Started with Zend Framework</a></li>
            <li class="list-group-item"><a href="unit-testing/">Unit Testing A zend-mvc Application</a></li>
            <li class="list-group-item"><a href="navigation/">Adding zend-navigation to the Album Module</a></li>
            <li class="list-group-item"><a href="pagination/">Adding zend-paginator to the Album Module</a></li>
